...
class Product extends Component {
    ...
    render(){
        ...
        return (
            <div>
                <Checkbox isChecked={isChecked} onChange={()=>checkedProduct(productId)}/>
                产品编号:{productId}
            </div>
        )
    }
    ...
    render(){
        ...
        return (
            <div>
                <div>+++++++++++++++++++订单开始+++++++++++++++++++</div>
                <div>
                    <Checkbox isChecked={isAllChecked} onChange={()=>checkedOrder(orderInfo)}/>
        ...
        render(){
            return (
                <div>
                    ...
                    <div>
                        <button onClick={this.outputCheckedList}>输出所选中的内容(控制台查看)</button>
                    </div>
                </div>
            )
        }
